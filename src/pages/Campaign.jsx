      ...
      <div className="campaign-hero">
        <div>
          <span className="premium-badge">
            AI SMS Campaign Builder
          </span>

          <h1>Create Professional SMS Campaigns</h1>

          <p>
            Create engaging SMS campaigns, manage audience targeting
            and save campaign history directly into MongoDB.
          </p>
        </div>
      ...
      <div className="campaign-grid">
        <div className="campaign-form-card">
          <div className="section-header">
            ...
            <p>Write your SMS content and audience details.</p>
          </div>
          ...
          <form onSubmit={createCampaign}>
            ...
            >
              ...
              <option value="General Customers">
                General Customers
              </option>
              <option value="Premium Customers">
                Premium Customers
              </option>
        ...
        <div className="campaign-preview-card">
          <div className="section-header">
            ...
            <p>Preview how your campaign will look.</p>
          </div>
